...
| <a name="input_Creator"></a> [Creator](#input\_Creator) | Provide creator name to identify resource owner. | `string` | `"Develover"` | no |
...
| <a name="input_cidr_blocks_for_public"></a> [cidr\_blocks\_for\_public](#input\_cidr\_blocks\_for\_public) | A list of subnets to allow FROM access to rds | `list(string)` | <pre>[<br>  "91.193.126.245/32",<br>  "46.37.195.48/32"<br>]</pre> | no |
...
| <a name="input_description"></a> [description](#input\_description) | Provide short service or application description. | `string` | `"Aurora cluster with users and priv in base"` | no |
...
| <a name="input_vpc_id"></a> [vpc\_id](#input\_vpc\_id) | Provide VPC ID for RDS database | `string` | `"vpc-0d10ca02d76485f8e"` | no |
| <a name="input_vpc_rds_security_group_ids"></a> [vpc\_rds\_security\_group\_ids](#input\_vpc\_rds\_security\_group\_ids) | List of SG to be allowed to connect to the DB instance including VPN | `list(string)` | <pre>[<br>  "sg-0735f6983ac540c39"<br>]</pre> | no |
